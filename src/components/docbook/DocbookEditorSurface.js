...
import { Box, ClickAwayListener, IconButton, Tooltip, Stack, Paper, Typography, Switch } from "@mui/material";
              ...
              >
                <Box
                  sx={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    bgcolor: activeNoteTint,
                    animation: "docbookAiPulse 1.8s ease-out infinite",
                  }}
                />
                <Typography sx={{ fontSize: 11, fontWeight: 800, color: "#2e261f", letterSpacing: "0.04em", textTransform: "uppercase" }}>
                  AI Working
                </Typography>
              </Box>
            ) : null}

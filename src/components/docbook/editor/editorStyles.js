...
export function getEditorSx(editorFontScale = 1) {
  return {
    ...
    "& span[data-user-mention], & span[data-folder-ref], & span[data-location-ref]": {
      ...
      fontSize: "inherit",
      borderRadius: 999,
      paddingInline: "0.14em 0.28em",
      paddingBlock: "0.04em",
      marginInline: "0.04em",
      background: "rgba(255, 252, 247, 0.92)",
      border: "1px solid rgba(139, 94, 60, 0.16)",
      boxShadow: "0 4px 10px rgba(92, 61, 46, 0.08)",
      color: "#3e2f24",
      lineHeight: 1,
      userSelect: "none",
    ...
    "& span[data-user-mention]:hover, & span[data-folder-ref]:hover, & span[data-location-ref]:hover": {
      ...
      boxShadow: "0 6px 14px rgba(92, 61, 46, 0.12)",
      borderColor: "rgba(139, 94, 60, 0.28)",
    },
    "& span[data-user-mention]": {
      fontSize: "0.74em",
      gap: "0.24em",
      paddingInline: "0.12em 0.3em",
      paddingBlock: "0.06em",
      ...
      boxShadow: "0 4px 10px rgba(223, 157, 108, 0.1), inset 0 1px 0 rgba(255,255,255,0.88)",
    },
    "& span[data-user-mention]:hover": {
      borderColor: "rgba(223, 157, 108, 0.42)",
      boxShadow: "0 6px 14px rgba(223, 157, 108, 0.14), inset 0 1px 0 rgba(255,255,255,0.92)",
    },
    "& span[data-chip-avatar='true']": {
      ...
      boxShadow: "0 2px 6px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.26)",
      flexShrink: 0,
    },
